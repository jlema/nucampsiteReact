                        ...
                        <LocalForm onSubmit={values => this.handleSubmit(values)}>
                            ...
                            <Row className="form-group">
                                <Col>
                                    ...
                                    <Control.text model=".author" name="author" validators={{ minLength: minLength(2), maxLength: maxLength(15) }} className="form-control"></Control.text>
                            ...
                            <Row className="form-group">
                                <Col>
                                    ...
                                    <Control.textarea model=".text" name="text" rows="6" className="form-control"></Control.textarea>
                                </Col>
                            </Row>
                            <Row className="form-group">
                                <Col>
