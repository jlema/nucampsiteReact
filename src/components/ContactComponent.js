...
class Contact extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            feedback: '',
            touched: { //checks if the user entered anything on these fields
                firstName: false,
                lastName: false,
                phoneNum: false,
                email: false
    ...
    handleSubmit(values) {
        let currState = "Current state is: " + JSON.stringify(values);
                    ...
                    <div className="col-md-10">
                        <Form model="feedbackForm" onSubmit={values => this.handleSubmit(values)}>
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    <Control.text model=".phoneNum" id="phoneNum" name="phoneNum" placeholder="Phone number" className="form-control" validators={{ required, minLength: minLength(10), maxLength: maxLength(15), isNumber }} />
